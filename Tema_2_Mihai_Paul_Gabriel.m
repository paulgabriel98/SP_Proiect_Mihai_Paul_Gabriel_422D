...
figure(1)
%Reprezint spectrul de amplitudini cu functia "stem" pentru ca e discret
stem(k, A) 
xlabel("Omega")
ylabel("A")
axis([-5 5 0 2])
...
%Declar un vector nul, care va reprezenta semnalul reconstruit.
sum = [];
for t = BEGIN:rez_temp:END
    %Declar suma partiala pe care urmeaza sa o adaug in vector si o 
    %initializez cu 0.
    sum1 = 0; 
    for k = 1:1:50
